...
enum _DateHelperTimeTextType { DateHelperTimeTextTypeCut= -1, DateHelperTimeTextTypeColon, DateHelperTimeTextTypeNone,DateHelperTimeTextTypeYMD,DateHelperTimeTextTypeYMDNone,DateHelperTimeTextTypeDefault};
enum _DateHelperTimeForShowForm { DateHelperTimeForShowFormList= 1, DateHelperTimeForShowFormDetail};
